        ...
        public class DisableAbility
        {
            ...
            public static IEnumerator StopAbility(float duration)
            {
                ...
                while (true)
                {
                    ...
                    else if (PlayerControl.LocalPlayer.Is(RoleEnum.Doctor)) CrewmateRoles.DoctorMod.KillButtonTarget.SetTarget(HudManager.Instance.KillButton, null, Role.GetRole<Doctor>(PlayerControl.LocalPlayer));
                    ...
                    else if (PlayerControl.LocalPlayer.Is(RoleEnum.Avenger))
                    {
                        ...
                        avenger.AvengeButton.SetTarget(null);
                    }
