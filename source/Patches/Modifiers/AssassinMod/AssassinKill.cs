    ...
    public class AssassinKill
    {
        ...
        )
        {
            ...
            if (checkLover == true)
            {
                ...
                if (killer.Is(RoleEnum.Hunter) || killer.Is(RoleEnum.Deputy) || killer.Is(RoleEnum.Jailor))
                {
                    ...
                    if (killer.Is(RoleEnum.Deputy))
                    {
                        var killerRole = Role.GetRole<Deputy>(killer);
                        killerRole.UsedShoot = true;
                    }
                }
