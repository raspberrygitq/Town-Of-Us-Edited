    ...
    public static class Patches
    {
        ...
        private class SettingsUpdate
        {
            ...
            public static void Postfix(GameSettingMenu __instance)
            {
                ...
                CreateSettingLoader(__instance, 9, "ImportSettings");
                CreateSettingLoader(__instance, 10, "ExportSettings");
            }
            ...
            public static void CreateSettings(GameSettingMenu __instance, int target, string name, string text, GameObject settingsButton, MultiMenu menu)
            {
                ...
                if (target == 3)
                {
                    SpawnExternalButton(__instance, tabOptions, ref num, "Load Custom Settings", "Main", 9);
                    SpawnExternalButton(__instance, tabOptions, ref num, "Save Custom Settings", "Main", 10);
                }
