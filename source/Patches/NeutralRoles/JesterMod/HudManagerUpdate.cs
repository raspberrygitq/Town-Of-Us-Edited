    ...
    public class HudManagerUpdate
    {
        public static void Postfix(HudManager __instance)
        {
            ...
            if (role.TimerText != null)
            {
                ...
                if (role.ScatterTimer() >= 10f)
                {
                    role.TimerText.text = "<color=#00FF00FF>" + role.TimerText.text + "</color>";
                }
                else if (role.ScatterTimer() >= 5f)
                {
                    role.TimerText.text = "<color=#FF9900FF>" + role.TimerText.text + "</color>";
                }
                else
                {
                    role.TimerText.text = "<color=#FF0000FF>" + role.TimerText.text + "</color>";
                }
            }
