...
namespace TownOfUsEdited.CrewmateRoles.JailorMod
{
    ...
    public class MeetingStart
    {
        public static void Postfix(MeetingHud __instance)
        {
            ...
            {
                HudManager.Instance.Chat.AddChat(PlayerControl.LocalPlayer, "Use chat below the map to communicate with your jailee.");
            }
        }
        ...
        public static IEnumerator ShowJailed()
        {
            ...
            HudManager.Instance.shhhEmblem.Body.sprite = TownOfUsEdited.JailCellSprite;
